...
int main()
{
	...
	DiskMultiMap tmp;
	tmp.createNew("tmpFile.dat", 2);

	tmp.insert("Test", "This", "Thing");
	tmp.insert("Help", "This", "Hard");
	tmp.insert("Test", "Other", "Thing");
	tmp.insert("Test", "One More Tiny", "Thing");
	tmp.insert("Test", "One More Tiny", "Thing");
	tmp.insert("Test", "One More Tiny", "Thing");
	tmp.insert("Test", "One Last Tiny", "Thing");
	
	DiskMultiMap::Iterator it = tmp.search("Test");
	while (it.isValid())
	{
		++it;
	}
	...
	while (it.isValid())
	{
		cout << (*it).key << '\t';
		cout << (*it).value << '\t';
		cout << (*it).context << endl;
		++it;
	}
	cout << endl;
	
	cout << endl << "DELETING: " << tmp.erase("Test", "One More Tiny", "Thing") << endl << endl;
	it = tmp.search("Test");
	while (it.isValid())
	{
		cout << (*it).key << '\t';
	...
	cout << endl << "DELETING: " << tmp.erase("Test", "One Last Tiny", "Thing") << endl << endl;
	it = tmp.search("Test");
	while (it.isValid())
	{
		cout << (*it).key << '\t';
	...
	cout << "---" << endl << endl;
	tmp.openExisting("tmpFile.dat");

	cout << endl << "DELETING: " << tmp.erase("Test", "Other", "Thing") << endl << endl;
	it = tmp.search("Test");
	while (it.isValid())
	{
		cout << (*it).key << '\t';
	...
	cout << endl << "DELETING: " << tmp.erase("Test", "This", "Thing") << endl << endl;
	it = tmp.search("Test");
	while (it.isValid())
	{
		cout << (*it).key << '\t';
	...
	vector<std::string> indicators = {"qqqqqa.exe", "chrome.exe", "boots.ptr"};
	vector<std::string> badEntitiesFound;
	std::vector<InteractionTuple> interactions;

	iw.purge("chrome.exe");
	iw.purge("qqqqqa.exe");
	iw.crawl(indicators, 6, badEntitiesFound, interactions);

	for (int i = 0; i < badEntitiesFound.size(); i++)
		cout << "FOUND: " <<  badEntitiesFound[i] << endl;
